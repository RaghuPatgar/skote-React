...
const Products = props => {
  ...
  //meta title
  document.title="Products | Sprentzo";
  ...
  const [FilterSports, setFilterSports] = useState([
    { id: 1, name: "Football", link: "#" },
    { id: 2, name: "Vollyball", link: "#" },
    { id: 3, name: "Cricket", link: "#" },
    { id: 4, name: "Tennis", link: "#" },
  ])
  ...
  return (
    <React.Fragment>
      <div className="page-content">
        <Container fluid>
          <Breadcrumbs title="" breadcrumbItem="Products" />
          <Row>
          <Col lg="3">
              <Card>
                <CardBody>
                  ...
                  <div>
                    <h5 className="font-size-14 mb-3">Sports</h5>
                    {/* Render Cloth Categories */}
                    <ul className="list-unstyled product-list">
                      {FilterSports.map((cloth, key) => (
                        <li key={"_li_" + key}>
                          <Link to={cloth.link}>
